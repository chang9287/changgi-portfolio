...
export default function Footer() {
  return (
    <footer className="py-4 md:py-0 w-full min-h-16 md:h-16 flex flex-col-reverse gap-3 justify-center items-center md:relative bg-white dark:bg-common-bg border-t border-white dark:border-gray-800">
