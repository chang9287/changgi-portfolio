...
export default function HomeNav() {
  ...
  /* Common Style */
  const linkClass = "relative border-2 w-64 h-32 font-bold text-5xl flex p-3 items-end rounded-xl text-main-brown border-main-brown group hover:bg-main-brown hover:text-white transition duration-200";
